...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/questions/:bundleId/add">{() => <AdminGuard component={AdminQuestionFormPage} />}</Route>
      <Route path="/admin/questions/:bundleId/edit/:questionId">{() => <AdminGuard component={AdminQuestionFormPage} />}</Route>
